...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[var(--background)] text-slate-900">
      ...
      <main className="mx-auto max-w-6xl px-6 pb-16 pt-8 lg:pt-12">
        <section id="profile" className="relative mt-12 flex flex-col gap-12 lg:mt-16 lg:flex-row lg:items-center lg:gap-14">
